            ...
            <div class="page-header-actions">
                ...
                <div class="btn-group" role="group" style="margin-left: 7px;" id="status-btn">
                    ...
                    <div class="dropdown-menu" aria-labelledby="exampleGroupDrop1" role="menu">
                        ...
                        <a class="dropdown-item" onclick="setDraft()" role="menuitem">Draft</a>
                        <a class="dropdown-item" onclick="setPublished()" role="menuitem">Published</a>
                    </div>
                </div>
                    ...
                    <table class="table table-default dataTable">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"></th>
                                <th class="cell-80" scope="col">Chef</th>
