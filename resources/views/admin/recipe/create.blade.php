                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('category', App\Models\RecipeCategory::pluck('name', 'id'), old('category'), ['class' => 'form-control', 'id' => 'category']) !!}
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Minute</label>
                                        {!! Form::text('time', old('time'), ['class' => 'form-control', 'id' => 'time']) !!}
                                    </div>
                                    <div class="form-group">
                                        <label>Servings</label>
                                        {!! Form::text('servings', old('servings'), ['class' => 'form-control', 'id' => 'servings']) !!}
                                    </div>
                                    <div class="form-group">
                                        <label>Chef</label>
                                        {!! Form::text('chef', old('chef'), ['class' => 'form-control', 'id' => 'chef']) !!}
                                    </div>
                                </div>
                                <div class="col-md-4"">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            {!! Form::text('published_at', old('published_at'), ['class' => 'datepicker form-control', 'id' => 'published_at']) !!}
                                    ...
                                    <div class="form-group m-b-0">
                                        ...
                                        <div class="ingredients">
                                            <div class="ingredient row" style="padding-bottom: 10px">
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="ingredient-name[]" placeholder="Ingredient 1" required="">
                                                </div>

                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="ingredient-amount[]" placeholder="Amount 1" required="">
                                                </div>
                                            </div>

                                            <div class="ingredient row" style="padding-bottom: 10px">
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="ingredient-name[]" placeholder="Ingredient 2">
                                                </div>

                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="ingredient-amount[]" placeholder="Amount 2">
                                                </div>
                                            </div>

                                            <div class="ingredient row" style="padding-bottom: 10px">
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="ingredient-name[]" placeholder="Ingredient 3">
                                                </div>

                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="ingredient-amount[]" placeholder="Amount 3">
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                            ...
                            <div class="form-group m-b-0">
                                ...
                                <div class="directions">
                                    <div class="direction" style="padding-bottom: 10px">
                                        <textarea type="text" class="form-control" name="direction-name[]" placeholder="Step 1" required=""></textarea>
                                    </div>

                                    <div class="direction" style="padding-bottom: 10px">
                                        <textarea type="text" class="form-control" name="direction-name[]" placeholder="Step 2"></textarea>
                                    </div>

                                    <div class="direction" style="padding-bottom: 10px">
                                        <textarea type="text" class="form-control" name="direction-name[]" placeholder="Step 3"></textarea>
                                    </div>
                                </div>
