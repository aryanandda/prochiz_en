                                ...
                                <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    {!! Form::text('date_start_at', old('date_start_at'), ['class' => 'datepicker form-control', 'id' => 'date_start_at']) !!}
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    {!! Form::text('time_start_at', old('time_start_at'), ['class' => 'timepicker form-control', 'id' => 'time_start_at']) !!}
                                                    <span class="input-group-addon">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    {!! Form::text('date_end_at', old('date_end_at'), ['class' => 'datepicker form-control', 'id' => 'date_end_at']) !!}
                                                    <span class="input-group-addon">
                                                        <span class="icon md-calendar"></span>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    {!! Form::text('time_end_at', old('time_end_at'), ['class' => 'timepicker form-control', 'id' => 'time_end_at']) !!}
                                                    <span class="input-group-addon">
                                                        <span class="icon md-time"></span>
                                                    </span>
                                                </div>
