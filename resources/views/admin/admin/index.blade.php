    ...
    <div class="page-main">
        ...
        <div class="page-header">
            ...
            <div class="page-header-actions">
                <button" class="btn btn-success pull-xs-right ml-1" onclick="createAction()">Create Admin</button>
            </div>
        </div>
...
var tab = $('.dataTable').DataTable({
    ...
    "serverSide": true,
    "ajax": {
        "url": "{{ action('Admin\AdminController@api') }}"
    },
    "aaSorting": [[0, 'asc']],
    "bJQueryUI": false,
    "bAutoWidth": true,
...
function createPerform()
{
    ...
    var request = $.ajax({
        url: "{{ action('Admin\AdminController@store') }}",
        headers: {
...
function updatePerform()
{
    ...
    var urlx = '{{ action('Admin\AdminController@index') }}/'+x;
