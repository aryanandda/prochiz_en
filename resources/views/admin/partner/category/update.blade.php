...
@section('body')
<?php 
    $name = $partnercat->name;
    $metadesc = $partnercat->metadesc;
    $description = $partnercat->description;
...
{!! Form::open(['url' => $update_link, 'id' => 'the-form', 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
    ...
    <div class="page-main">
        ...
        <div class="page-header">
            <h1 class="page-title">Update Partner Category</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">Dashboard</a></li>
                <li class="breadcrumb-item active"><a href="{{ $index_link }}">Partner Category</a></li>
                <li class="breadcrumb-item active">Update Partner Category</li>
            </ol>
