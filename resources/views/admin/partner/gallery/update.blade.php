...
@section('body')
<?php 
    $caption = $partnergallery->caption;
    $partner_id = $partnergallery->partner_id;
    $image = $partnergallery->image;

    if(!empty(old('partner_id'))){
                            ...
                            <div class="row">                                
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label>Caption</label>
                                        {!! Form::text('caption', $caption, ['class' => 'form-control', 'id' => 'caption']) !!}
                                    </div>
                                    <div class="form-group">
                                        <?php 
                                        ...
                                        {!! Form::select('partner_id', $partners, $partner_id, array('class' => 'form-control', 'data-plugin' => 'select2') ) !!}
                                        <div class="error"></div>
                                    </div>
                                </div>
                                <div class="col-md-4">
