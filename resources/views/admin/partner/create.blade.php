...
{!! Form::open(['url' => $store_link, 'id' => 'the-form', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
    ...
    <div class="page-main">
        ...
        <div class="page-header">
            <h1 class="page-title">Create Partner</h1>
            <ol class="breadcrumb">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <label>Hours</label>
                                        {!! Form::text('hours', old('hours'), ['class' => 'form-control', 'id' => 'hours']) !!}
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('instagram', old('instagram'), ['class' => 'form-control', 'id' => 'instagram']) !!}
                                    </div>
